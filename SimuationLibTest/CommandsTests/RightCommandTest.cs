...
namespace SimulationLibTest.CommandsTests
{
    ...
    public class RightCommandTest
    {
        ...
        public void Setup()
        {
            ...
            _rightCommand = new RightCommand(_robotMock.Object, _placementValidationServiceMock.Object);
        }

        [Test]
        public void ExecuteCommand_Should_Call_The_Robot_To_TurnRight()
        {
            _rightCommand.ExecuteCommand();
            _robotMock.Verify(x => x.TurnRight(),Times.Once);
        }
    }
}
